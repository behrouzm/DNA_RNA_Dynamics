rm(list=ls())
getwd()
setwd("/Users/behrouz/DNA_RNA_R/Final Report-20230527/")


### 1st Step; Load raw data with minfi and create and RGset
library(minfi)
baseDir <- ("/Users/behrouz/DNA_RNA_R/Final Report-20230527/Input/")
...
load("/Users/behrouz/DNA_RNA_R/Final Report-20230527/RGset.RData")
...
load("/Users/behrouz/DNA_RNA_R/Final Report-20230527/Illumina450Manifest_clean.RData") #load Illumina_manifest450_clean file

Illumina450Manifest_clean[Illumina450Manifest_clean$AddressA_ID=="31763489",]  #checking the address probe inside the manifest file
# infinium Type II, IlmnID = cg01311227 has both red and green
Illumina450Manifest_clean[Illumina450Manifest_clean$AddressB_ID=="31763489",] # No addressB_ID with this address because it is infinium II type
Illumina450Manifest_clean[Illumina450Manifest_clean$IlmnID=="cg01311227",]

Red[rownames(Red)=="31763489",]
Green[rownames(Green)=="31763489",]
...
load("/Users/behrouz/DNA_RNA_R/Final Report-20230527/MSet_raw.RData")
